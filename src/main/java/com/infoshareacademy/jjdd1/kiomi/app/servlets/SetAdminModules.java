 ...
 */
@WebServlet(urlPatterns = "/setadminmodules")
public class SetAdminModules extends HttpServlet {
    @Inject
...
//            req.setAttribute("errorMessage", errorMessage);
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("SetAdminModules.jsp");
