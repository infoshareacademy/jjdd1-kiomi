 ...
 */
@WebServlet(urlPatterns = "/carstatistics")
public class CarStatistics extends HttpServlet {
    @Inject
...
//        req.setAttribute("partNameAndCountMap", partNameAndCountMap);
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("carStatistics.jsp");
