...
<div class="container">
    <div class="lightbox text-center">
        ...
        <div class="row">
            ...
            <div class="col-xs-12" id="listaEbay">
                <div class="  col-xs-12 col-md-6">
                    <div class="list-group-item headCzSzcz"
                       style="font-weight: bold; font-size: 1.3em; text-align: center">Znalezione na Ebay</div>
